...
class Header extends Component {
    ...
    loginHandler = () => {
        ...
        axios({
            ...
            localStorage.setItem("user", JSON.stringify(result.data.user.firstName));
            localStorage.setItem("isLoggedIn", true);
            this.setState({
                user: result.data.user.firstName,
                isLoggedIn: true,
                loginError: undefined,
                isLoginModalOpen: false
            });
            ...
            <React.Fragment>
                            ...
                            <div className="loginSection col-6">
                                {
                                    ...
                                    ?
                                    <>
                                     <span className="text-white m-4">{user, loggedInUserName}</span>
                ...
                <Modal isOpen={isLoginModalOpen} style={customStyles}>
                    ...
                    <div className="text-center mt-2">
                        ...
                        />
                        <GoogleLogin 
                            clientId="877331332722-edc73m3eqh1g8nvtkdveu36lu51sfkuc.apps.googleusercontent.com"
